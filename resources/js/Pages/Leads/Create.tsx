...
import { PageProps, User, LeadFormData } from '@/types';
...
export default function Create({ auth, availableUsers, priorities, leadSources, projects, unitTypes }: Props) {
    ...
    return (
        ...
        >
            <Head title="Create Lead - NUSA CRM" />
